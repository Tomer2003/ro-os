...
kernel.bin: kernel_entry.o kernel.o port_io.o vga_driver.o memcpy.o utoa.o reverse.o idt.o setBits.o gdt.o memset.o
	ld -o kernel.bin -Ttext 0x9500 kernel_entry.o utoa.o reverse.o memcpy.o port_io.o idt.o vga_driver.o kernel.o gdt.o memset.o setBits.o --oformat binary
